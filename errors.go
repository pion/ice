...
var (
	...
	// unsupported.
	//
	// Deprecated: use ErrUnsupportedAddressRewriteCandidateType instead.
	...
	//
	// Deprecated: use ErrInvalidAddressRewriteMapping instead.
	...
	//
	// Deprecated: use ErrAddressRewriteIPNotFound instead.
	ErrExternalMappedIPNotFound = errors.New("external mapped IP not found")
	// ErrAddressRewriteIPNotFound is an alias for ErrExternalMappedIPNotFound.
	ErrAddressRewriteIPNotFound = ErrExternalMappedIPNotFound
	...
	//
	// Deprecated: use ErrMulticastDNSWithAddressRewrite instead.
	...
	//
	// Deprecated: use ErrIneffectiveAddressRewriteHost instead.
	...
	//
	// Deprecated: use ErrIneffectiveAddressRewriteSrflx instead.
