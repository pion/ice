...
type AgentConfig struct {
	...
	//
	// Note: libwebrtc is the only other ICE implementation that supports renomination. If you are
	// connecting to a peer that does not support renomination, this will add some load to your
