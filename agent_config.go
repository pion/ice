...
type AgentConfig struct {
	...
	// EnableActiveTCP enables active TCP candidate gathering. When enabled, Pion will attempt to connect to the other
	// peer's passive TCP candidates. This is disabled by default.
